...
@Description(name = "_bitmap", value = "_FUNC_(expr) - Returns the bitmap of a column")
public class GenericUDAFBitmap extends AbstractGenericUDAFResolver {

  static final Log LOG = LogFactory.getLog(GenericUDAFBitmap.class.getName());
  ...
  public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters)
    ...
    return new GenericUDAFBitmapEvaluator();
  }

  public static class GenericUDAFBitmapEvaluator extends GenericUDAFEvaluator {
