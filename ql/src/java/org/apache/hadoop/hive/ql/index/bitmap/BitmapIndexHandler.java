...
public class BitmapIndexHandler extends AbstractIndexHandler {
  ...
  public void analyzeIndexDefinition(Table baseTable, Index index,
    ...
    if (this.usesIndexTable() && indexTable != null) {
      ...
      FieldSchema offSets = new FieldSchema("_bitmaps", "map<string, array<bigint> >", "");
      indexTblCols.add(offSets);
  ...
  private Task<?> getIndexBuilderMapRedTask(Set<ReadEntity> inputs, Set<WriteEntity> outputs, 
    ...
    command.append(VirtualColumn.FILENAME.getName() + "," + VirtualColumn.BLOCKOFFSET.getName());
